    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default='2019:01:02', max_length=12, verbose_name='Fecha Final')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vote', models.CharField(choices=[('Primera Fecha', 1), ('Segunda Fecha', 2), ('Tercera Fecha', 3)], max_length=15, verbose_name='Que fecha sera la carnita')),
