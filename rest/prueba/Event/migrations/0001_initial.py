    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email4', models.EmailField(max_length=254, verbose_name='Cuarto invitado')),
                ('email5', models.EmailField(max_length=254, verbose_name='Quinto invitado')),
                ('email6', models.EmailField(max_length=254, verbose_name='Sexto invitado')),
                ('email7', models.EmailField(max_length=254, verbose_name='Septimo invitado')),
